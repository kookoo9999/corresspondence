#ifndef __GET_CORRESSPONDENCE_H__
#define __GET_CORRESSPONDENCE_H__
...
//Armadillo Matrix for Dynamic assginment
typedef struct St_correspondence_mat
{
	mat CadData;
	mat measureed_data;
	mat error_cal;
	...
	mat Rotation;
	mat err = eye(8, 1);
}St_correspondence_mat;

class getCorresspondence
{
public:
	...
	//Similar functions of MATLAB find()
	...
	void ShowMat()
	{
		cout << "Get Corresspondence process" << endl;
...
#endif __GET_CORRESSPONDENCE_H__